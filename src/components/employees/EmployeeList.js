...
const EmployeeList = () => {
  ...
  const getErpData = async()=>{
    try{
      const {data} = await ErpService.getErpData("/employee")
  ...
  return (
    <CommonLayout>
      ...
      <ARMCard title={SyncErpData('EMPLOYEES LIST', getErpData)}>
            ...
            <ARMTable>
              ...
              <tbody>
                {departments.map((dep) => (
                  <tr key={dep.id}>
                    <td>{dep.name}</td>
                    <td>{dep.fatherName}</td>
                    <td>{dep.motherName}</td>
                    <td>{dep.email}</td>
                    <td>{dep.officePhone}</td>
                    <td>
                      <Space size="small">
                        <ARMButton
                          type="primary"
