...
const Parts = () => {
    ...
    return (
        <CommonLayout>
            ...
            <ARMCard
                title={
                    getLinkAndTitle('Parts', '/planning/parts/add', true)
                }
            >
                <ARMForm
                        ...
                        <tbody>
                        {
                            collection?.map((part, index) => (
                                ...
                                <tr key={index}>
                                    ...
                                    <td> {part.classification===0 ? 'ROTABLE' : part.classification===1 ? 'CONSUMABLE': part.classification===2 ? 'EXPENDABLE' : null}</td>
                                    <td> {part.unitOfMeasure===0? 'EACH' : null}</td>
                                    <td>
                                        <Space size='small'>
                                            ...
                                            <ActiveInactiveButton
                                                ...
                                                handleOk={async () => {
                                                    try {
                                                        await PartsServices.toggleStatus(part.id, !part.isActive);
